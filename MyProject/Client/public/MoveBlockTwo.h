...
BEGIN(Client)
class CMoveBlockTwo final : public CGameObject
{
private:
	explicit CMoveBlockTwo(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CMoveBlockTwo(const CMoveBlockTwo& rhs);
	virtual ~CMoveBlockTwo() = default;
public:
...
public:
	static	CMoveBlockTwo* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
