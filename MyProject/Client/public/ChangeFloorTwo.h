...
BEGIN(Client)
class CChangeFloorTwo final : public CGameObject
{
private:
	explicit CChangeFloorTwo(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CChangeFloorTwo(const CChangeFloorTwo& rhs);
	virtual ~CChangeFloorTwo() = default;
public:
...
public:
	static	CChangeFloorTwo* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
