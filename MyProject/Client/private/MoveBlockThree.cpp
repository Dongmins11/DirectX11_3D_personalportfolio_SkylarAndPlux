#include "stdafx.h"
#include "..\public\MoveBlockThree.h"
#include "GameInstance.h"
#include "Rock.h"


CMoveBlockThree::CMoveBlockThree(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CMoveBlockThree::CMoveBlockThree(const CMoveBlockThree & rhs)
	: CGameObject(rhs)
{
}

HRESULT CMoveBlockThree::Native_Construct_Prototype()
{
...
HRESULT CMoveBlockThree::Native_Construct(void* pArg, _uint iMyLevelIndex)
{
	...
	if (nullptr != pArg)
	{
		...
		_float aa = m_pModelDesc_Client->vPos.x - 8.5;
		m_pRopeTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(aa, m_pModelDesc_Client->vPos.y, m_pModelDesc_Client->vPos.z, m_pModelDesc_Client->vPos.w));
...
_int CMoveBlockThree::Tick(_double TimeDelta)
{
...
_int CMoveBlockThree::LateTick(_double TimeDelta)
{
...
HRESULT CMoveBlockThree::Render()
{
...
HRESULT CMoveBlockThree::Player_Collision_Check(_double TimeDelta)
{
...
HRESULT CMoveBlockThree::Set_Pos()
{
...
HRESULT CMoveBlockThree::Rope_Look(_double TimeDelta)
{
...
HRESULT CMoveBlockThree::Move_State(_double TimeDelta)
{
...
HRESULT CMoveBlockThree::SetUp_Component_Load()
{
	/* Com_Renderer */
...
HRESULT CMoveBlockThree::SetUp_Component()
{
	/* Com_Renderer */
	if (FAILED(__super::SetUp_Component(LEVEL_STATIC, TEXT("Prototype_Component_Renderer"), TEXT("Com_Renderer"), (CComponent**)&m_pRendererCom)))
		return E_FAIL;
...
HRESULT CMoveBlockThree::SetUp_ConstantTable()
{
...
CMoveBlockThree * CMoveBlockThree::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CMoveBlockThree* pInstance = new CMoveBlockThree(pDevice, pDeviceContext);
	if (FAILED(pInstance->Native_Construct_Prototype()))
	{
		MSGBOX("Failed to Create CMoveBlockThree");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CMoveBlockThree::Clone(void* pArg, _uint iMyLevelIndex)
{
	CMoveBlockThree* pInstance = new CMoveBlockThree(*this);
