#include "stdafx.h"
#include "..\public\TempleHead.h"
#include "GameInstance.h"



CTempleHead::CTempleHead(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CTempleHead::CTempleHead(const CTempleHead & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTempleHead::Native_Construct_Prototype()
{
...
HRESULT CTempleHead::Native_Construct(void* pArg, _uint iMyLevelIndex)
{
...
_int CTempleHead::Tick(_double TimeDelta)
{
...
_int CTempleHead::LateTick(_double TimeDelta)
{
...
HRESULT CTempleHead::Set_VecCollider()
{
...
void CTempleHead::Collision_Check()
{
...
HRESULT CTempleHead::SetUp_Component_Load()
{
	/* Com_Renderer */
...
HRESULT CTempleHead::SetUp_Component()
{
	/* Com_Renderer */
	if (FAILED(__super::SetUp_Component(LEVEL_STATIC, TEXT("Prototype_Component_Renderer"), TEXT("Com_Renderer"), (CComponent**)&m_pRendererCom)))
		return E_FAIL;
...
HRESULT CTempleHead::SetUp_ConstantTable()
{
...
CTempleHead * CTempleHead::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CTempleHead* pInstance = new CTempleHead(pDevice, pDeviceContext);
	if (FAILED(pInstance->Native_Construct_Prototype()))
	{
		MSGBOX("Failed to Create CTempleHead");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CTempleHead::Clone(void* pArg, _uint iMyLevelIndex)
{
	CTempleHead* pInstance = new CTempleHead(*this);
