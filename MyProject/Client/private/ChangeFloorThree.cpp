#include "stdafx.h"
#include "..\public\ChangeFloorThree.h"
#include "GameInstance.h"
#include "Rock.h"

CChangeFloorThree::CChangeFloorThree(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CChangeFloorThree::CChangeFloorThree(const CChangeFloorThree & rhs)
	: CGameObject(rhs)
{
}

HRESULT CChangeFloorThree::Native_Construct_Prototype()
{
...
HRESULT CChangeFloorThree::Native_Construct(void* pArg, _uint iMyLevelIndex)
{
...
_int CChangeFloorThree::Tick(_double TimeDelta)
{
...
_int CChangeFloorThree::LateTick(_double TimeDelta)
{
...
HRESULT CChangeFloorThree::Render()
{
...
HRESULT CChangeFloorThree::Change_Scale(_double TimeDelta)
{
...
HRESULT CChangeFloorThree::Change_Model()
{
	...
	if (true == m_bRenderChange)
	{
		...
		if (FAILED(m_pModelCom->Render(13)))
			return E_FAIL;
	}
...
HRESULT CChangeFloorThree::Collision_Check()
{
...
HRESULT CChangeFloorThree::SetUp_Component_Load()
{
	/* Com_Renderer */
...
HRESULT CChangeFloorThree::SetUp_Component()
{
	/* Com_Renderer */
	if (FAILED(__super::SetUp_Component(LEVEL_STATIC, TEXT("Prototype_Component_Renderer"), TEXT("Com_Renderer"), (CComponent**)&m_pRendererCom)))
		return E_FAIL;
	...
	ColliderDesc.vCenter = _float3(0.0f, 0.1f, 0.0f);
	ColliderDesc.vExtents = _float3(2.7f, 0.7f, 2.7f);
	ColliderDesc.fRadius = 500.f;
...
HRESULT CChangeFloorThree::SetUp_ConstantTable()
{
	if (nullptr == m_pModelCom)
		return E_FAIL;
...
CChangeFloorThree * CChangeFloorThree::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CChangeFloorThree* pInstance = new CChangeFloorThree(pDevice, pDeviceContext);
	if (FAILED(pInstance->Native_Construct_Prototype()))
	{
		MSGBOX("Failed to Create CChangeFloorThree");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CChangeFloorThree::Clone(void* pArg, _uint iMyLevelIndex)
{
	CChangeFloorThree* pInstance = new CChangeFloorThree(*this);
