#include "stdafx.h"
#include "..\public\ChangeFloorFor.h"
#include "GameInstance.h"
#include "Rock.h"

CChangeFloorFor::CChangeFloorFor(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CChangeFloorFor::CChangeFloorFor(const CChangeFloorFor & rhs)
	: CGameObject(rhs)
{
}

HRESULT CChangeFloorFor::Native_Construct_Prototype()
{
...
HRESULT CChangeFloorFor::Native_Construct(void* pArg, _uint iMyLevelIndex)
{
	...
	else
	{
		...
		m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(233.f, 22.f, 106.f, 1.f));
	}
...
_int CChangeFloorFor::Tick(_double TimeDelta)
{
...
_int CChangeFloorFor::LateTick(_double TimeDelta)
{
...
HRESULT CChangeFloorFor::Render()
{
...
HRESULT CChangeFloorFor::Change_Scale(_double TimeDelta)
{
...
HRESULT CChangeFloorFor::Change_Model()
{
...
HRESULT CChangeFloorFor::Collision_Check()
{
...
HRESULT CChangeFloorFor::SetUp_Component_Load()
{
	/* Com_Renderer */
...
HRESULT CChangeFloorFor::SetUp_Component()
{
	/* Com_Renderer */
	if (FAILED(__super::SetUp_Component(LEVEL_STATIC, TEXT("Prototype_Component_Renderer"), TEXT("Com_Renderer"), (CComponent**)&m_pRendererCom)))
		return E_FAIL;
...
HRESULT CChangeFloorFor::SetUp_ConstantTable()
{
	if (nullptr == m_pModelCom)
		return E_FAIL;
...
CChangeFloorFor * CChangeFloorFor::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CChangeFloorFor* pInstance = new CChangeFloorFor(pDevice, pDeviceContext);
	if (FAILED(pInstance->Native_Construct_Prototype()))
	{
		MSGBOX("Failed to Create CChangeFloorFor");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CChangeFloorFor::Clone(void* pArg, _uint iMyLevelIndex)
{
	CChangeFloorFor* pInstance = new CChangeFloorFor(*this);
