...
CLeft_Bullet::CLeft_Bullet(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CLeft_Bullet::CLeft_Bullet(const CLeft_Bullet & rhs)
	: CGameObject(rhs)
{
}

HRESULT CLeft_Bullet::Native_Construct_Prototype()
{
...
HRESULT CLeft_Bullet::Native_Construct(void* pArg, _uint iMyLevelIndex)
{
...
_int CLeft_Bullet::Tick(_double TimeDelta)
{
...
_int CLeft_Bullet::LateTick(_double TimeDelta)
{
...
HRESULT CLeft_Bullet::HitEffect_Create(_double TimeDelta)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLeft_Bullet::Effect_Create(_double TimeDelta)
{
...
HRESULT CLeft_Bullet::Floor_CollisionCheck(_double TimeDelta)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
_int CLeft_Bullet::Boss_CollisionCheck(_double TimeDelta)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLeft_Bullet::Magenetic_IsIn(_double TimeDelta)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLeft_Bullet::Go_Direction(_double TimeDelta)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
	CTransform* pTargetTransform = (CTransform*)pGameInstance->Get_Components(m_iMyLevel, L"Clone_Player", L"Com_Transform", 0, 0);
...
HRESULT CLeft_Bullet::SetUp_Component()
{
	/* Com_Renderer */
...
HRESULT CLeft_Bullet::SetUp_ConstantTable()
{
	if (nullptr == m_pModelCom)
		return E_FAIL;
...
CLeft_Bullet * CLeft_Bullet::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CLeft_Bullet*	pInstance = new CLeft_Bullet(pDevice, pDeviceContext);

	if (FAILED(pInstance->Native_Construct_Prototype()))
	{
		MSGBOX("Failed to Created : CLeft_Bullet");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CLeft_Bullet::Clone(void* pArg, _uint iMyLevelIndex)
{
	CLeft_Bullet*	pInstance = new CLeft_Bullet(*this);
