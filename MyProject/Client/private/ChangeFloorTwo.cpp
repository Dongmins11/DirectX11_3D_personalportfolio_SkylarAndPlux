#include "stdafx.h"
#include "..\public\ChangeFloorTwo.h"
#include "GameInstance.h"
#include "Rock.h"

CChangeFloorTwo::CChangeFloorTwo(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CChangeFloorTwo::CChangeFloorTwo(const CChangeFloorTwo & rhs)
	: CGameObject(rhs)
{
}

HRESULT CChangeFloorTwo::Native_Construct_Prototype()
{
...
HRESULT CChangeFloorTwo::Native_Construct(void* pArg, _uint iMyLevelIndex)
{
...
_int CChangeFloorTwo::Tick(_double TimeDelta)
{
...
_int CChangeFloorTwo::LateTick(_double TimeDelta)
{
...
HRESULT CChangeFloorTwo::Render()
{
...
HRESULT CChangeFloorTwo::Change_Scale(_double TimeDelta)
{
...
HRESULT CChangeFloorTwo::Change_Model()
{
...
HRESULT CChangeFloorTwo::Collision_Check()
{
...
HRESULT CChangeFloorTwo::SetUp_Component_Load()
{
	/* Com_Renderer */
...
HRESULT CChangeFloorTwo::SetUp_Component()
{
	/* Com_Renderer */
	if (FAILED(__super::SetUp_Component(LEVEL_STATIC, TEXT("Prototype_Component_Renderer"), TEXT("Com_Renderer"), (CComponent**)&m_pRendererCom)))
		return E_FAIL;
...
HRESULT CChangeFloorTwo::SetUp_ConstantTable()
{
	if (nullptr == m_pModelCom)
		return E_FAIL;
...
CChangeFloorTwo * CChangeFloorTwo::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CChangeFloorTwo* pInstance = new CChangeFloorTwo(pDevice, pDeviceContext);
	if (FAILED(pInstance->Native_Construct_Prototype()))
	{
		MSGBOX("Failed to Create CChangeFloorTwo");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CChangeFloorTwo::Clone(void* pArg, _uint iMyLevelIndex)
{
	CChangeFloorTwo* pInstance = new CChangeFloorTwo(*this);
