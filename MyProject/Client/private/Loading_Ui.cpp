...
HRESULT CLoading_Ui::Native_Construct_Prototype()
{
...
HRESULT CLoading_Ui::Native_Construct(void* pArg, _uint iMyLevelIndex)
{
...
CGameObject * CLoading_Ui::Clone(void* pArg, _uint iMyLevelIndex)
{
