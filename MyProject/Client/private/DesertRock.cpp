#include "stdafx.h"
#include "..\public\DesertRock.h"
#include "GameInstance.h"


CDesertRock::CDesertRock(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CDesertRock::CDesertRock(const CDesertRock & rhs)
	: CGameObject(rhs)
{
}

HRESULT CDesertRock::Native_Construct_Prototype()
{
...
HRESULT CDesertRock::Native_Construct(void* pArg, _uint iMyLevelIndex)
{
...
_int CDesertRock::Tick(_double TimeDelta)
{
...
_int CDesertRock::LateTick(_double TimeDelta)
{
...
HRESULT CDesertRock::SetUp_Component()
{
	/* Com_Renderer */
...
HRESULT CDesertRock::SetUp_ConstantTable()
{
	...
	if (FAILED(m_pFilterTextureCom->SetUp_OnShader("g_FilterTexture", m_pModelCom)))
		return E_FAIL;
...
CDesertRock * CDesertRock::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CDesertRock* pInstance = new CDesertRock(pDevice, pDeviceContext);
	if (FAILED(pInstance->Native_Construct_Prototype()))
	{
		MSGBOX("Failed to Create CDesertRock");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CDesertRock::Clone(void* pArg, _uint iMyLevelIndex)
{
	CDesertRock* pInstance = new CDesertRock(*this);
