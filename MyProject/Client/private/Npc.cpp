...
HRESULT CNpc::Native_Construct_Prototype()
{
...
HRESULT CNpc::Native_Construct(void* pArg, _uint iMyLevelIndex)
{
...
HRESULT CNpc::Animation_Change()
{
	if (true == m_bAnimCageCheck && m_iCurMotion == NPC_CRY)
	{
		CSound_Manager::Get_Instance()->StopSound(CSound_Manager::ID_NPC_LOYA);
		CSound_Manager::Get_Instance()->PlaySound(L"Npc_Help", CSound_Manager::ID_NPC_LOYA);
...
CGameObject * CNpc::Clone(void* pArg, _uint iMyLevelIndex)
{
