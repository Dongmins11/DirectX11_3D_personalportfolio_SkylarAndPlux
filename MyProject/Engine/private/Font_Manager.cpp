...
HRESULT CFont_Manager::Draw_Font(const _tchar * pFontTag, const _tchar* pText, _float2 vPosition, _fvector vColor, _float fScale)
{
	...
	return pFont->Draw(pText, vPosition, vColor, fScale);
}
