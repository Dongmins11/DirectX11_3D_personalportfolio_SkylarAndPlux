...
HRESULT CVIBuffer::Create_VetexBuffer()
{
...
HRESULT CVIBuffer::Create_VetexBuffer2()
{
	if (nullptr == m_pDevice)
		return E_FAIL;
...
HRESULT CVIBuffer::Complie_Shader(const _tchar* pShaderFilePath, D3D11_INPUT_ELEMENT_DESC* pElements, _uint iNumElements)
{
	_uint			iFlag = 0;
#ifdef _DEBUG
